...
<body>
    ...
    <form method="POST" action="update.php" class="mb-3">
        ...
        <div class="mb-3">
            <label for="title" class="form-label">職業</label>
            <input type="text" class="form-control" name="job" id="job" aria-describedby="job" value="<?= $row["job"] ?>">
        </div>
        <div class="mb-3">
            <label for="content" class="form-label">一言メッセージ</label>
